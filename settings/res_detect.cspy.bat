...
"C:\Program Files (x86)\IAR Systems\Embedded Workbench 6.0 Evaluation\common\bin\cspybat" "C:\Program Files (x86)\IAR Systems\Embedded Workbench 6.0 Evaluation\430\bin\430proc.dll" "C:\Program Files (x86)\IAR Systems\Embedded Workbench 6.0 Evaluation\430\bin\430fet.dll"  %1 --plugin "C:\Program Files (x86)\IAR Systems\Embedded Workbench 6.0 Evaluation\430\bin\<libsupport_plugin>" --backend -B "--hardware_multiplier" "16" "--hwmult_type" "1" "-p" "C:\Program Files (x86)\IAR Systems\Embedded Workbench 6.0 Evaluation\430\config\MSP430F149.ddf" "--iv_base" "0xFFE0" "-d" "fet" "--verify_all" "--erase_main_and_info" "--derivative" "MSP430F149" "--vccvoltage=3.3" "--allow_locked_flash_access" "--protocol" "4wire" "--eem" "EMEX_MEDIUM" "--port" "Automatic" "--connection" "ti_usb" "--settlingtime=0" "--allow_access_to_BSL" "--msp430_dll" "msp430.dll" 
